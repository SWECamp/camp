    ...
    <meta property="og:title" content="One page website template for multipurpose website" />
     ...
     <!---Common css---->
        ...
        <!----Media queries css--->
         ...
         <link href="<?php echo base_url(); ?>template/css/theme1024.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>template/css/theme990.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>template/css/theme768.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>template/css/theme480.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>template/css/theme320.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>template/css/theme319.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>template/css/quickweb.css" rel="stylesheet" type="text/css" />
     <link href="<?php echo base_url(); ?>template/fonts/style.css" rel="stylesheet" type="text/css" />   
   <link href="<?php echo base_url(); ?>template/css/slider_css.css" type="text/css" rel="stylesheet" />
