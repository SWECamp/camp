        ...
        <div class="container">
        	<h2 class="text-center">กิจกรรมท่องเที่ยว</h2><br><br><br>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style=" margin-bottom: 100px; ">
                        ...
                        <div class="col-md-6 text-left" style="padding-top: 50px; ">
                             <span>  <b>อุทยานแห่งชาติเขาหลวง  </b> <br>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style=" margin-bottom: 100px; ">
                	...
                	<div class="col-md-6 text-center ">
                                <img src="<?php echo base_url(); ?>template/image/tm2.jpg" width="70%" class="img-circle      " alt="Image">
                        </div>
                </div>

                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style=" margin-bottom: 100px; ">
                	<div class="col-md-6 text-center  ">
                                <img src="<?php echo base_url(); ?>template/image/tm1.jpg" width="70%" class="img-circle      " alt="Image">
                        </div>
                	<div class="col-md-6 text-left" style="padding-top: 50px; ">
                		
        				<b>เที่ยวชมโลมาสีชมพู ดำน้ำทะเลขนอม</b><br>
